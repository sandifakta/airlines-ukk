		...
		<header id="ticktravel-header-section" class="sticky-banner">
			<div class="container">
				<div class="nav-header">
					...
					<h1 id="ticktravel-logo"><a href="<?php echo base_url('') ?>"><i class="icon-airplane"></i>Flay Travel</a></h1>
					...
					<div class="col-md-12 col-sm-12 ticktravel-tours animate-box fadeInUp animated" data-animate-effect="fadeIn" style="background: url('<?php echo $trute->gambar?> ');background-size: cover; background-position: center;">
						<div href="#">
								<div style="position: relative;" class="desc">
									...
									<span class="price"><?php echo "Rp " .number_format($trute->regane)?><?php $this->session->set_userdata('priceee', $trute->regane); ?> <span style="font-size: 15px; display: inline;">/ tiket</span></span>
