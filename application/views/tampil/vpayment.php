			...
			<div class="container">
				<form action="" method="post">			
					<div  class="col-md-12 col-sm-12" style="padding-top: 30px;">
						<h3>Transfer total pemesanan</h3>
					</div>
					...
					<div  class="col-md-3 col-sm-6"><?php echo  $depart_at; ?></div>

					<div class="col-md-2 col-sm-6 col-md-offset-7" >total penumpang </div>
					<div  class="col-md-3 col-sm-6"><?php echo  $jml; ?></div>

					<div class="col-md-2 col-sm-6 col-md-offset-7" >total harga </div>
					<div  class="col-md-3 col-sm-6" style="padding-bottom: 20px"><?php echo "Rp " .number_format($rega * $jml)?></div>
					...
					<form action="<?php echo base_url('action/konfirmasi') ?>" method="post">
							...
							<input type="file" name="fotoBarangBukti" class="form-control" style="padding-bottom: 50px"><br><br>
							<button type="submit" class="btn btn-info" style="margin-bottom: 30px">Upload</button>
					</form>
			</div>
		</div>
