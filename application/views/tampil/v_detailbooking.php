		...
		<header id="ticktravel-header-section" class="sticky-banner">
			<div class="container">
				<div class="nav-header">
					...
					<h1 id="ticktravel-logo"><a href="#"><i class="icon-airplane"></i>Fly Travel</a></h1>
		...
		<div class="ticktravel">
			<div class="container">
				<form action="<?php echo base_url('action/booking') ?>" method="post">			
					...
					<div class="col-md-2 col-sm-6" >harga tiket </div>
					<div class="col-md-10 col-sm-6" ><?php echo "Rp " .number_format($priceee)?></div>

					<div class="col-md-2 col-sm-6" >total pembayaran </div>
					<div class="col-md-10 col-sm-6" style="padding-bottom: 20px"><?php echo "Rp " .number_format($priceee * $jml)?></div>
